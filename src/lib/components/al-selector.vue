            ...
            init() {
                if (this.value && this.value.length > 0) {
                    ...
                    if(this.value[0] instanceof Object){
                        let codes=this.value.map(item=>item.code);
                        if (codes[0]!=null) {
                            if (areaData[86][codes[0]]) {
                                this.currPro = areaData[86][codes[0]];
                                this.provIndex = codes[0];
                            }
                        }
                        if (codes[1] != null) {
                            this.currCit = areaData[codes[0]][codes[1]];
                            this.cityIndex = codes[1];
                        }
                        if (codes[2] != null) {
                            this.currCou = areaData[codes[1]][codes[2]];
                            this.counIndex = codes[2];
                        }
                        if (codes[3] != null) {
                            this.currStr = areaData[codes[2]][codes[3]];
                            this.streIndex = codes[3];
                        }
                    } else if (isNaN(parseInt(this.value[0])) && !(this.value[0] instanceof Object)) {
                        if (this.value[0] != null && util.getIndex(this.provList, this.value[0])){
                        ...
                        if (this.value[2] != null){
                            this.currCou = this.value[2];
                        }

                        if (this.value[3] != null){
                            this.currStr = this.value[3];
                        }
                        ...
                        if (this.value[1] != null) {
                            ...
                            this.cityIndex = this.value[1];
                        }
                        if (this.value[2] != null) {
                            this.currCou = areaData[this.value[1]][this.value[2]];
                            this.counIndex = this.value[2];

                        }
                        if (this.value[3] != null) {
                            this.currStr = areaData[this.value[2]][this.value[3]];
                            this.streIndex = this.value[3];
                        }
                    }
                }
            },
                ...
                if (level <= this.showLevel) {
                    ...
                    if (this.isInit && this.value[level]) {
                        ...
                        if(valueItem instanceof Object){
                            if (util.getIndex(this[list], this.value[level].name)) {
                                name = valueItem.name;
                            }
                        }
                        else if (isNaN(parseInt(valueItem))) {
                    ...
                    if (areaData[this[index]]) {
                        ...
                        if (this.isInit && this.cloneValue[level + 1]) {
                            ...
                            if(valueNextItem instanceof Object){
                                if (util.getIndex(this[nextList], this.cloneValue[level + 1].name)) {
                                    nextSelected = this.cloneValue[level + 1].name;
                                }
                            }
                            else if (isNaN(parseInt(valueNextItem))) {
